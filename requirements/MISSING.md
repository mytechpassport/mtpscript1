...
| [ ] **Gas Cost Alignment** | `mtpscript-core/src/gas/costs.rs` | 36-43 | Correct gas costs for `DbRead` (50) and `HttpOut` (100) to match Annex A. Verify and fix `DbWrite` (currently 120). | `Op::DbRead => 50, Op::HttpOut => 100, Op::DbWrite => <spec_val>` |
