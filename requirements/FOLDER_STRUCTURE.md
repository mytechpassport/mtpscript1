...
- `crypto/` - Cryptographic operations (mtp_js_crypto.c/h)
- `db/` - Database integration (mtp_js_db.c/h)
- `effects/` - Side effect tracking (mtp_js_effects.c/h, mtp_js_log.c/h)
- `http/` - HTTP client/server (mtp_js_http.c/h)
- `runtime/` - Core VM and execution (mtp_js.c/h, runtime.c/h)
- `stdlib/` - Standard library (mtp_js_api.c/h)
